...
**
** Created: Tue Mar 12 18:50:33 2013
...
void network_test::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        network_test *_t = static_cast<network_test *>(_o);
        switch (_id) {
        case 0: _t->check_conn(); break;
...
const QMetaObjectExtraData network_test::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject network_test::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_network_test,
      qt_meta_data_network_test, &staticMetaObjectExtraData }
};
