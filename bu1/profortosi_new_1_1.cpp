...
profortosi_new_1_1::profortosi_new_1_1(QWidget *parent,QTcpSocket *pclient,QString ccode,QString customer,QString car1,QString car2)
    : QDialog(parent)
{
	client=pclient;
	this->ccode=ccode;
...
void profortosi_new_1_1::finalize()
{
		...
		out << quint16(0)<<req_type<<ccode<<customer<<car1<<car2<<ui.tableWidget->item(i,0)->text()<<ui.labelWeight->text();
		out.device()->seek(0);
