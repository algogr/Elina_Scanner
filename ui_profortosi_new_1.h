...
**
** Created: Mon Jan 9 18:06:00 2012
...
public:
    ...
    void setupUi(QDialog *profortosi_new_1Class)
    {
        ...
        lineEdit_3->setGeometry(QRect(90, 10, 171, 23));
        ...
        tableWidget->setGeometry(QRect(0, 40, 311, 151));
        tableWidget->verticalHeader()->setVisible(false);
        searchButton = new QPushButton(profortosi_new_1Class);
        searchButton->setObjectName(QString::fromUtf8("searchButton"));
        searchButton->setGeometry(QRect(270, 10, 41, 27));
        checkGreek = new QCheckBox(profortosi_new_1Class);
        checkGreek->setObjectName(QString::fromUtf8("checkGreek"));
        checkGreek->setGeometry(QRect(10, 200, 72, 21));
    ...
    void retranslateUi(QDialog *profortosi_new_1Class)
    {
        ...
        checkGreek->setText(QApplication::translate("profortosi_new_1Class", "\316\225\316\233\316\233\316\227\316\235\316\231\316\232\316\221", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
